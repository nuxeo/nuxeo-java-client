...
public interface Client {
     ...
     * Builtin methods:<br/>
     * <ul>
     * <li>{@link org.nuxeo.client.spi.auth.BasicAuthInterceptor}</li>
     * <li>{@link org.nuxeo.client.spi.auth.PortalSSOAuthInterceptor}</li>
     * <li>{@link org.nuxeo.client.spi.auth.TokenAuthInterceptor}</li>
     * </ul>
     */

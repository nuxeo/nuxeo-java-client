# Java Client Library 1.3-SNAPSHOT for the Nuxeo Platform REST APIs
...
You can download the client on our Nexus: [Nuxeo Client Library 1.3-SNAPSHOT](https://maven.nuxeo.org/nexus/#nexus-search;gav~org.nuxeo.client~nuxeo-java-client~1.3-SNAPSHOT~jar~).
...
```
compile 'org.nuxeo.client:nuxeo-java-client:1.3-SNAPSHOT'
```

Ivy:

```
<dependency org="org.nuxeo.client" name="nuxeo-java-client" rev="1.3-SNAPSHOT" />
...
```
libraryDependencies += "org.nuxeo.client" % "nuxeo-java-client" % "1.3-SNAPSHOT"
```

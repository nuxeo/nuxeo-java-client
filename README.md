# Java Client Library 3.1.1-SNAPSHOT for the Nuxeo Platform REST APIs
...
You can download the client on our Nexus: [Nuxeo Client Library 3.1.1-SNAPSHOT](https://maven.nuxeo.org/nexus/#nexus-search;gav~org.nuxeo.client~nuxeo-java-client~3.1.1-SNAPSHOT~jar~)
...
```
compile 'org.nuxeo.client:nuxeo-java-client:3.1.1-SNAPSHOT'
```

Ivy:

```
<dependency org="org.nuxeo.client" name="nuxeo-java-client" rev="3.1.1-SNAPSHOT" />
...
```
libraryDependencies += "org.nuxeo.client" % "nuxeo-java-client" % "3.1.1-SNAPSHOT"
```

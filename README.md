# Java Client Library 2.6 for the Nuxeo Platform REST APIs
...
You can download the client on our Nexus: [Nuxeo Client Library 2.6](https://maven.nuxeo.org/nexus/#nexus-search;gav~org.nuxeo.client~nuxeo-java-client~2.6~jar~)
...
```
compile 'org.nuxeo.client:nuxeo-java-client:2.6'
```

Ivy:

```
<dependency org="org.nuxeo.client" name="nuxeo-java-client" rev="2.6" />
...
```
libraryDependencies += "org.nuxeo.client" % "nuxeo-java-client" % "2.6" 
```

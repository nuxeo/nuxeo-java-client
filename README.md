# Java Client Library 3.4.0 for the Nuxeo Platform REST APIs
...
You can download the client on our Nexus: [Nuxeo Client Library 3.4.0](https://maven.nuxeo.org/nexus/#nexus-search;gav~org.nuxeo.client~nuxeo-java-client~3.4.0~jar~)
...
```
compile 'org.nuxeo.client:nuxeo-java-client:3.4.0'
```

Ivy:

```
<dependency org="org.nuxeo.client" name="nuxeo-java-client" rev="3.4.0" />
...
```
libraryDependencies += "org.nuxeo.client" % "nuxeo-java-client" % "3.4.0"
```
